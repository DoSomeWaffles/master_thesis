    ...
    public class AcousticsProbesRenderer : AcousticsActualRenderer
    {
        ...
        public override void Render()
        {
            ...
            if (m_probePoints.Count == 0)
            {
                ...
                AcousticsPALPublic.TritonVec3d curLocation = new AcousticsPALPublic.TritonVec3d();
                for (int curProbe = 0; curProbe < numProbes; curProbe++)
                {
                    ...
                    m_probePoints.Add(AcousticsEditor.TritonToWorld(curLocation.ToVector3()));
                }
            }
