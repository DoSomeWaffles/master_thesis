...
namespace Microsoft.Acoustics.Editor
{
    public class AcousticsParameters : ScriptableObject, ISerializationCallbackReceiver
    {
        ...
        public const string DefaultTritonImage = "mcr.microsoft.com/acoustics/baketools:2022.1.Linux";
        ...
        public Vector3 PerProbeSimulationRegion_Lower = new Vector3(-45, -45, -10);
        public Vector3 PerProbeSimulationRegion_Upper = new Vector3(45, 45, 20);
