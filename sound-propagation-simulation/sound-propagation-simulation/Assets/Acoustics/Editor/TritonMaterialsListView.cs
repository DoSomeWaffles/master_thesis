...
namespace Microsoft.Acoustics.Editor
{
    public class TritonMaterialsListView : TreeView
    {
        ...
        private AcousticMaterialLibrary m_MaterialLibrary;
        ...
        public TritonMaterialsListView(TreeViewState state, MultiColumnHeader multicolumnHeader, AcousticMaterialLibrary materialLibrary, List<TritonMaterialsListElement> seedData)
        ...
        public AcousticMaterialLibrary MaterialLibrary
        {
