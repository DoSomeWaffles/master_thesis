...
Simulation is a tool to generate data, but it is a tool that can generate bad data. The simulation can generate data that does not represent real-life data. If the simulation generates data that does not represent real-life data, the classification score on the real-life data will be low.
